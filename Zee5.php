...
<head>
    <!-- Navbar -->
    <div class="navbar">
        <h1> bd live streaming </h1>
    </div> 
    
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title> bd live streaming</title>
...
<link rel="me" href="https://t.me/+ulRfl5XQ8wRhOTVk" />
...
<center>
     <marquee class="notice-movies" scrollamount="4">
       ➤  bd live streaming আপনাকে স্বাগতম Welcome To bd live streaming প্রিয় গ্রাহক আপনার অবগতির জন্য জানানো যাচ্ছে যে আমাদের এই ওয়েবসাইটির কাজ চলছে তাই টিভি দেখতে কিছু চ্যানেল সমস্যা করতে পারে আমাদের এক্সপার্ট টিম বিষয়টি পর্যবেক্ষণ করছেন ধন্যবাদ....?
     </marquee>
</center>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>© 2025 bd live streaming. All rights reserved.</p>
